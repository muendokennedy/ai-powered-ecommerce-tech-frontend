...
const fetchRelatedProducts = async () => {
  ...
  try{
    const response = await axiosClient.get(`/api/products/${route.params.id}/related`)
...
const image = computed(() => activeImage.value ?? null)
...
<template>
  ...
  <main class="menu-toggle">
    <section class="product-home mt-16 px-[4%] mx-auto lg:max-w-[1500px]">
      ...
      <div class="bg-white rounded-xl shadow-lg mt-4 p-6 border border-gray-100">
