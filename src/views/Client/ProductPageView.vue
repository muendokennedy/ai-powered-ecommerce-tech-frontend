        ...
        <div class="w-full md:basis-[48%] p-2 sm:p-4 flex flex-col items-center">
          ...
          <div class="w-full sm:w-4/5 flex justify-between gap-2 md:gap-4 mx-auto">
            <div class="small-image h-20 border-2 p-1 sm:p-2 rounded-md cursor-pointer">
              <img src="../assets/images/redmi note 12.png" alt="Extra small image description" class="h-full object-cover">
            </div>
            <div class="small-image h-20 border-2 p-1 sm:p-2 rounded-md cursor-pointer">
              <img src="../assets/images/techno spark 5.png" alt="Extra small image description" class="h-full object-cover">
            </div>
            <div class="small-image h-20 border-2 p-1 sm:p-2 rounded-md cursor-pointer">
              <img src="../assets/images/xiaomi redmi 10 2022 pro.png" alt="Extra small image description" class="h-full object-cover">
            </div>
            <div class="small-image h-20 border-2 p-1 sm:p-2 rounded-md cursor-pointer">
              <img src="../assets/images/iphone12.png" alt="Extra small image description" class="h-full object-cover">
            </div>
          </div>
